        ...
        <div className="relative self-center">
          <div className="relative ml-40 w-full">
             <Image 
                ...
                height={423} 
                alt="image sporton"
                className="grayscale absolute -left-40 -top-20"
            />
             <div className="text-primary italic">Friday Sale, 50% </div>
             <h1 className="font-extrabold text-[95px] italic bg-gradient-to-b loading-tight from-black to-[#979797] bg-clip-text text-transparent">
          ...
          <div className="flex gap-5 mt-14">
            <Button>Explore More<FiFastForward/> </Button>
             <Button variant="ghost">Watch Video <Image src="/images/icon-play-video.svg" alt="icon playvideo"
              width={29} 
              height={29} 
              /> 
            </Button>
